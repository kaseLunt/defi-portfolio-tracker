...
import { EtherFiInsightsCard } from "@/components/etherfi/etherfi-insights-card";
...
export default function WalletDashboardPage({ params }: Props) {
  ...
  useEffect(() => {
    params.then((p) => {
      ...
      if (/^0x[a-fA-F0-9]{40}$/.test(wallet)) {
        ...
        // Invalid wallet, redirect to dashboard
  ...
  // Reset to 7d when wallet changes
  ...
  const {
    ...
    isFetching,
    refetch,
  } = useFastPortfolio(walletAddress || undefined);
  ...
  const {
    ...
    tokenPriceHistory,
  } = usePortfolioHistory(walletAddress || undefined, historyTimeframe, {
  ...
  return (
    <div className="min-h-screen pb-16">
      ...
      <div className="container space-y-8">
        ...
        {!tokensLoading && !tokensError && (
          <>
            ...
            {/* EtherFi Insights Card */}
            <div className="animate-in" style={{ animationDelay: "320ms" }}>
              <EtherFiInsightsCard walletAddress={walletAddress} />
            </div>

            {/* Main Content Grid */}
            <div className="grid gap-6 lg:grid-cols-3">
              {/* Token Holdings */}
              <div className="lg:col-span-2 animate-in" style={{ animationDelay: "350ms" }}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {!defiLoading && positions.length > 0 && (
                      <span className="text-sm text-muted-foreground">
                        ...
                        {byProtocol.length} protocol{byProtocol.length !== 1 ? "s" : ""}
                      </span>
                    )}
                  </div>
                </CardHeader>
                    ...
                    <div className="flex items-center justify-center py-16">
                      <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="text-center">
                          <p className="text-sm font-medium mb-1">Discovering DeFi positions</p>
      ...
      <PositionDetailSheet
        ...
        protocolName={
          selectedPosition
            ? byProtocol.find((p) => p.protocol === selectedPosition.protocol)?.name
            : undefined
        }
